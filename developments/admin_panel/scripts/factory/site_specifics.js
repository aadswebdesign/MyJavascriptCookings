...
import * as SI_J from './svgManager/icons/svgIcons_J.js';// no content yet
import * as SI_K from './svgManager/icons/svgIcons_K.js';
import * as SI_L from './svgManager/icons/svgIcons_L.js';
import * as SI_M from './svgManager/icons/svgIcons_M.js';
...
export async function admin_panel_controls(){
	...
	await SI_M.Minimize('.test-block');
