...
const iconViewBox = {viewBox: '0 0 24 24', height: '100%', width: '100%'};
export const Calendar = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Calendar', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.calendar'),
...
export const CaretDown = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CaretDown', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.caret-down'),
...
export const CaretLeft = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CaretLeft', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.caret-left'),
...
export const CaretRight = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CaretRight', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.caret-right'),
...
export const CaretUp = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CaretUp', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.caret-up'),
...
export const ChevronDown = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ChevronDown', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.chevron-down'),
...
export const ChevronLeft = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ChevronLeft', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.chevron-left'),
...
export const ChevronRight = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ChevronRight', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.chevron-right'),
...
export const ChevronUp = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ChevronUp', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.chevron-up'),
...
export const ChevronsDown = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ChevronsDown', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.chevrons-down'),
...
export const ChevronsLeft = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ChevronsLeft', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.chevrons-left'),
...
export const ChevronsRight = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ChevronsRight', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.chevrons-right'),
...
export const ChevronsUp = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ChevronsUp', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.chevrons-up'),
...
export const Circle = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Circle', {...iconViewBox},'','',parent),
			await EL.svgTitle(null, null,null,title,null,'svg#Circle'),
			await EL.svgGroup('icon-group circle', null,null,null,null,'svg#Circle'),
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.circle'),
...
export const CircleMinus = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CircleMinus', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.circle-minus'),
...
export const CircleOff = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CircleOff', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.circle-off'),
...
export const CirclePlus = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CirclePlus', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.circle-plus'),
...
export const CircleX = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CircleX', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.circle-x'),
...
export const ClearAll = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ClearAll', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.clear-all'),
...
export const ClearFormatting = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ClearFormatting', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.clear-formatting'),
...
export const CodeMinus = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CodeMinus', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.code-minus'),
...
export const CodePlus = async (parent = null, title='') =>{//todo shape
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CodePlus', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.code-plus'),
...
export const Code = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Code', {...iconViewBox},'','',parent),
			await EL.svgTitle(null, null,null,title,null,'svg#Code'),
			await EL.svgGroup('icon-group code', null,null,null,null,'svg#Code'),
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.code'),
...
export const ColorPicker = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ColorPicker', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.color-picker'),
...
export const ColorSwatch = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ColorSwatch', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.color-swatch'),
...
export const Command = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Command', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.command'),
...
export const Crop = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Crop', {...iconViewBox},'','',parent),
			await EL.svgTitle(null, null,null,title,null,'svg#Crop'),
			await EL.svgGroup('icon-group crop', null,null,null,null,'svg#Crop'),
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.crop'),
...
export const Crosshair = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Crosshair', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.crosshair'),
...
export const CurrencyDollar = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CurrencyDollar', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.currency-dollar'),
...
export const CurrencyEuro = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CurrencyEuro', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.currency-euro'),
...
export const CurrentLocation = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CurrentLocation', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.current-location'),
...
export const CursorText = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'CursorText', {...iconViewBox},'','',parent),
			...
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.cursor-text'),
...
export const Cut = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Cut', {...iconViewBox},'','',parent),
			await EL.svgTitle(null, null,null,title,null,'svg#Cut'),
			await EL.svgGroup('icon-group cut', null,null,null,null,'svg#Cut'),
			await EL.svgPath('base-path', null,{...iconParentPath},null,null,'g.icon-group.cut'),
