...
export const Accessible = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Accessible', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.accessible'),
...
export const AccessibilityCheck = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'AccessibilityCheck', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.accessibility-check'),
...
export const AlertCircle = async (parent = null, title='') => {//todo
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'AlertCircle', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.alert-circle'),
...
export const AlertOctagon = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'AlertOctagon', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.alert-octagon'),
...
export const AlertTriangle = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'AlertTriangle', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.alert-triangle'),
...
export const AlignCenter = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'AlignCenter', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.align-center'),
...
export const AlignJustified = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'AlignJustified', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.align-justified'),
...
export const AlignLeft = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'AlignLeft', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.align-left'),
...
export const AlignRight = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'AlignRight', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.align-right'),
...
export const Anchor = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Anchor', {...standards.svg},'','',parent),
			await EL.svgTitle(null, null,null,title,null,'svg#Anchor'),
			await EL.svgGroup('icon-group anchor', null,null,null,null,'svg#Anchor'),
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.anchor'),
...
export const Apps = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Apps', {...standards.svg},'','',parent),
			await EL.svgTitle(null, null,null,title,null,'svg#Apps'),
			await EL.svgGroup('icon-group apps', null,null,null,null,'svg#Apps'),
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.apps'),
...
export const Archive = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Archive', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.archive'),
...
export const ArrowBack = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowBack', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.arrow-back'),
...
export const ArrowBackUp = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowBackUp', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.arrow-back-up'),
...
export const ArrowBarDown = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowBarDown', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.arrow-bar-down'),
...
export const ArrowBarLeft = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowBarLeft', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.arrow-bar-left'),
...
export const ArrowBarRight = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowBarRight', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.arrow-bar-right'),
...
export const ArrowBarToDown = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowBarToDown', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.arrow-bar-to-down'),
...
export const ArrowBarToLeft = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowBarToLeft', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.arrow-bar-to-left'),
...
export const ArrowBarToRight = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowBarToRight', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.arrow-bar-to-right'),
...
export const ArrowBarToUp = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowBarToUp', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.arrow-bar-to-up'),
...
export const ArrowBarUp = async (parent = null, title='') => {
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowBarUp', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.arrow-bar-up'),
...
export const ArrowDownCircle = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowDownCircle', {...standards.svg},'','',parent),
...
export const ArrowDownLeftCircle = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowDownLeftCircle', {...standards.svg},'','',parent),
...
export const ArrowDownLeft = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowDownLeft', {...standards.svg},'','',parent),
...
export const ArrowDownRightCircle = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowDownRightCircle', {...standards.svg},'','',parent),
...
export const ArrowDownRight = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowDownRight', {...standards.svg},'','',parent),
...
export const ArrowDown = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowDown', {...standards.svg},'','',parent),
...
export const ArrowUpCircle = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowUpCircle', {...standards.svg},'','',parent),
...
export const ArrowUpLeft = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowUpLeft', {...standards.svg},'','',parent),
...
export const ArrowUpLeftCircle = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowUpLeftCircle', {...standards.svg},'','',parent),
...
export const ArrowUpRight = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowUpRightCircle', {...standards.svg},'','',parent),
...
export const ArrowUpRightCircle = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowUpRight', {...standards.svg},'','',parent),
...
export const ArrowUp = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowUp', {...standards.svg},'','',parent),
...
export const ArrowsMaximize = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowsMaximize', {...standards.svg},'','',parent),
...
export const ArrowsMinimize = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ArrowsMinimize', {...standards.svg},'','',parent),
...
export const AspectRatio = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'AspectRatio', {...standards.svg},'','',parent),
...
export const At = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'At', {...standards.svg},'','',parent),
