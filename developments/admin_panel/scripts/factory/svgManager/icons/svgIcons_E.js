...
export const Edit = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Edit', {...standards.svg},'','',parent),
			await EL.svgTitle(null, null,null,title,null,'svg#Edit'),
			await EL.svgGroup('icon-group edit', null,null,null,null,'svg#Edit'),
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.edit'),
...
export const EditCircle = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'EditCircle', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.edit-circle'),
...
export const Equal = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Equal', {...standards.svg},'','',parent),
			await EL.svgTitle(null, null,null,title,null,'svg#Equal'),
			await EL.svgGroup('icon-group equal', null,null,null,null,'svg#Equal'),
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.equal'),
...
export const EqualNot = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'EqualNot', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.equal-not'),
...
export const Eraser = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'Eraser', {...standards.svg},'','',parent),
			await EL.svgTitle(null, null,null,title,null,'svg#Eraser'),
			await EL.svgGroup('icon-group eraser', null,null,null,null,'svg#Eraser'),
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.eraser'),
...
export const ExternalLink = async (parent = null, title='') =>{
	...
	if(null !== parent){
		icon = await [
			await EL.svg('svg-icon absolute', 'ExternalLink', {...standards.svg},'','',parent),
			...
			await EL.svgPath('base-path', null,{...standards.base_path},null,null,'g.icon-group.external-link'),
